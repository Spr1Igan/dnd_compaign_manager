...
return [
    ...
    'js' => [
        ...
        'race_bonus_title' => 'Бонус расы/подрасы :bonus. ',
        ...
        'subrace_summary' => ':name, скорость :speed, языки: :languages, особенности: :features',
        'class_summary' => ':name, кость хитов d:hitDie, спасброски: :savingThrows, навыки: :skills',
        'subclass_summary' => ':name, текущие особенности по уровню: :features',
        'background_summary' => ':name, навыки: :skills, языки: :languages, инструменты: :tools',
        'choose_race' => 'выбери расу',
        'choose_subrace' => 'выбери подрасу',
        'choose_class' => 'выбери класс',
        'choose_subclass' => 'выбери подкласс',
        'choose_background' => 'выбери предысторию',
        'feature_help_fallback' => ':feature — особенность персонажа от выбранной расы, подрасы, класса, подкласса или предыстории. Для более точной подсказки добавь описание этой особенности в справочник правил.',
    ],
];
